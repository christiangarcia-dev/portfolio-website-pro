    ...
    return (
        <section className='about' id='about'>
            ...
            <div className='about__content'>
                ...
                <p className='about__content__paragraph'>When I can I rejoice in diving into a good book or listening to thought-provoking podcasts. Check out out my <a href='https://medium.com/@2001christiangarcia/my-software-engineering-journey-32ac253c2a4a' target='_blank' rel='noopener noreferrer' className='about__content__paragraph--medium'>Medium</a> article to learn more about me!</p>
